...
<div class="container">
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Report by Salary (Max)</li>
  </ol>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
          ...
          <div class="panel-body">
             <form method="POST" action="/reports/salarymax" class="form">
              {{ csrf_field() }}
              <div class="row">
                <div class="form-group {{ $errors->has('salary') ? 'has-error' : '' }} col-sm-4">
                  {!! Form::Label('salary', 'Salary:') !!}
                   {!! Form::text('salary', '39000',array('class' => 'form-control','readonly'=>'true')) !!}
