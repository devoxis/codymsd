...
<div class="container">
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Report by Marital Status</li>
  </ol>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
          ...
          <div class="panel-body">
             <form method="POST" action="/reports/marital" class="form">
              {{ csrf_field() }}

              <div class="row">
                <div class="form-group {{ $errors->has('marital_status') ? 'has-error' : '' }} col-sm-4">
